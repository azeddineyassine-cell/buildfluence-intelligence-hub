(() => {
  const translations = {
    fr: {
      ...
      langButton: 'Langue : Français', downloadReport: 'Recevoir le rapport complet', langMenu: 'Choix de la langue',
      previewAnalysis: 'Consulter l\u2019aperçu gratuit', footerRights: '© 2026 Buildfluence · Tous droits réservés',
    ...
    en: {
      ...
      langButton: 'Language: English', downloadReport: 'Get the full report', langMenu: 'Language selection',
      previewAnalysis: 'View the free preview', footerRights: '© 2026 Buildfluence · All rights reserved',
    ...
    ar: {
      ...
      langButton: 'اللغة: العربية', downloadReport: 'الحصول على التقرير الكامل', langMenu: 'اختيار اللغة',
      previewAnalysis: 'الاطلاع على المعاينة المجانية', footerRights: '© 2026 Buildfluence · جميع الحقوق محفوظة',
