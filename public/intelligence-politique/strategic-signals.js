(() => {
  ...
  const gxCopy = {
    fr: {
      ...
      read3:'Ce que la galaxie ne dit pas : l’angle et la distance entre deux nœuds ne signifient rien. Une cooccurrence n’est ni une influence, ni une alliance, ni une causalité, ni un sondage d’opinion, ni une intention de vote.',
      ...
      gxLimit:'Cette lecture ne constitue ni un sondage d’opinion, ni une mesure des intentions de vote, ni une preuve de causalité.', focusTitle:'Voisinage documenté'
    },
    en: {
      ...
      read3:'What the galaxy does not say: angle and distance between two nodes carry no meaning. A co-occurrence is neither influence, nor alliance, nor causality, nor an opinion poll, nor voting intention.',
      ...
      gxLimit:'This reading is neither an opinion poll, nor a measure of voting intention, nor proof of causality.', focusTitle:'Documented neighbourhood'
    },
    ar: {
      ...
      read3:'ما لا تقوله المجرة: الزاوية والمسافة بين عقدتين لا تعنيان شيئا. التزامن ليس تأثيرا ولا تحالفا ولا سببية ولا استطلاعا للرأي ولا نية تصويت.',
      ...
      gxLimit:'لا تشكل هذه القراءة استطلاعا للرأي ولا قياسا لنوايا التصويت ولا دليلا على السببية.', focusTitle:'الجوار الموثق'
    }
  };
