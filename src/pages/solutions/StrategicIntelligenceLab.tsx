...
const OcpCaseFile = () => {
  ...
  <CaseFileSection>
    ...
    <CaseIntro
      ...
      body={lang === "en" ? <>Decoding the modus operandi of destabilisation campaigns against OCP and Moroccan interests, orchestrated by a constellation of <strong>front NGOs</strong> hidden behind the « humanitarian » banner and amplified by useful idiots.</> : <>Décryptage du mode opératoire de campagnes de fragilisation contre OCP et les intérêts du Maroc, orchestrées par une constellation d'<strong>ONG façades</strong> cachées sous le bandeau « humanitaires » et amplifiées par des idiots utiles.</>}
