  ...
  return (
    <DetailPageLayout
      ...
      stickyCase={{
        ...
        context: [
          t("Annonce de la 3e candidature présidentielle dans un climat tendu", "Announcement of the 3rd presidential candidacy in a tense climate"),
          t("Montée des appels à la rébellion, désinformation et polarisation numérique", "Rise of calls for rebellion, disinformation and digital polarization"),
        ],
        intervention: [
