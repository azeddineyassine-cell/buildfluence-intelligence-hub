  ...
  return (
    <DetailPageLayout
      ...
      stickyCase={{
        ...
        sector: t("Agroalimentaire", "Food & Beverage"),
        context: [
          t("2015, décès de 2 enfants après consommation du yaourt Raïbi Jamila", "2015, death of 2 children after consuming Raïbi Jamila yogurt"),
          t("Campagne de dénigrement pendant 2 ans", "Smear campaign for 2 years"),
          t("Conséquence : perte de 120M MAD (11,2M€)", "Consequence: loss of 120M MAD (€11.2M)"),
        ],
        intervention: [
