...
const AttaquesInformationnelles = () => {
  ...
  return (
    <DetailPageLayout
      ...
      chapeau={t(
        "Vulnérabilité aux manipulations et désinformations qui altèrent la perception de la réalité et sabotent les décisions stratégiques",
        "Vulnerability to manipulations and disinformation that alter the perception of reality and sabotage strategic decisions"
      )}
      ctas={[
    ...
    >
      <DetailBlock title={t("Votre réalité", "Your reality")}>
        <DetailList items={[
          ...
          t("Un tweet déstabilise votre levée de fonds", "A tweet destabilizes your fundraising"),
          ...
          t("Vous découvrez l'attaque quand elle est déjà virale. Trop tard, le coup est parti.", "You discover the attack when it's already viral. Too late, the blow has landed."),
        ]} />
      </DetailBlock>
      ...
      <DetailBlock title={t("Les chiffres qui font peur", "Frightening numbers")}>
        <DetailList items={[
          ...
          t("Un seul article négatif en ligne met 22% des clients potentiels à risque. Ce chiffre monte à 70% avec 4 articles négatifs ou plus (SurveySparrow, 2025)", "A single negative article online puts 22% of potential customers at risk. This rises to 70% with 4+ negative articles (SurveySparrow, 2025)"),
        ]} />
      </DetailBlock>
      ...
      <CaseStudy
        title={t("Cas client : Centrale Danone", "Case study: Centrale Danone")}
        context={t(
          "2015, décès de 2 enfants après consommation du yaourt Raïbi Jamila. Campagne de dénigrement pendant 2 ans. Conséquence : perte de 120M MAD (11,2M€).",
          "2015, death of 2 children after consuming Raïbi Jamila yogurt. Smear campaign for 2 years. Consequence: loss of 120M MAD (€11.2M)."
        )}
        intervention={[
          t("Digital investigation approfondie", "Deep digital investigation"),
        ...
        result={t(
          "Marque innocentée à 100%. Gain de +14% de parts de marché après la crise. Confiance restaurée.",
          "Brand 100% exonerated. +14% market share gain after the crisis. Trust restored."
        )}
      />
    </DetailPageLayout>
  );
