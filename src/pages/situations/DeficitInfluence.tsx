      ...
      sidebar={
        <div className="space-y-6">
          <StickyClientCase
            ...
            sector={t("Organisation internationale — Coopération économique", "International organization — Economic cooperation")}
            ...
            resultItems={[
              t("Repositionnement du CIDC comme hub d'opportunités économiques intra-OCI", "Repositioning of ICDT as an intra-OIC economic opportunities hub"),
              t("Passage d'un rôle institutionnel passif à une plateforme d'orchestration économique insight-driven", "Transition from a passive institutional role to an insight-driven economic orchestration platform"),
            ]}
          />
          <StickyClientCase
            logo={addLogo}
            title={t("ADD — Agence de Développement du Digital", "ADD — Digital Development Agency")}
            sector={t("Secteur public — Transformation digitale", "Public sector — Digital transformation")}
            ...
            resultItems={[
              t("Déploiement d'une solution de veille stratégique basée sur l'IA", "Deployment of an AI-based strategic monitoring solution"),
              t("Activation autour de GITEX Africa Morocco", "Activation around GITEX Africa Morocco"),
              t("Renforcement de la visibilité internationale de l'écosystème digital marocain", "Strengthening of the international visibility of the Moroccan digital ecosystem"),
            ]}
          />
        </div>
      }
