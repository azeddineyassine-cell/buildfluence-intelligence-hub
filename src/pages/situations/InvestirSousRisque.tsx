...
const InvestirSousRisque = () => {
  ...
  return (
    <DetailPageLayout
      ...
      chapeau={t(
        "Miser sans connaissance profonde : chaque investissement devient une loterie",
        "Betting without deep knowledge: every investment becomes a lottery"
      )}
      ctas={[
    ...
    >
      <DetailBlock title={t("Votre réalité", "Your reality")}>
        <DetailList items={[
          ...
          t("Les signaux d'alerte sur la fiabilité, l'intégrité ou la stabilité financière restent hors de portée", "Warning signals on reliability, integrity or financial stability remain out of reach"),
        ]} />
      </DetailBlock>
      ...
      <DetailBlock title={t("L'angle mort", "The blind spot")}>
        <DetailList items={[
          t("Les informations critiques sur vos cibles existent mais restent enfouies dans des sources disparates", "Critical information on your targets exists but remains buried in disparate sources"),
          t("Vous investissez sans la Due Diligence systématique que tout professionnel devrait conduire", "You invest without the systematic Due Diligence that every professional should conduct"),
      ...
      <DetailBlock title={t("Le coût de l'échec", "The cost of failure")}>
        <DetailList items={[
          t("70 à 90% des fusions-acquisitions échouent par manque de due diligence approfondie (CFA Institute, 2025)", "70 to 90% of M&A fail due to lack of deep due diligence (CFA Institute, 2025)"),
          ...
          <div className="rounded border border-border p-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {t(
                ...
                "PEP screening and sensitive affiliations. Weak signals: sanctions, litigation. Deliverable: Go/Vigilance/No-Go sheet"
              )}
            </p>
          </div>
          <div className="rounded border border-border p-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {t(
                ...
                "Stakeholder mapping. Geopolitical analysis. Deliverable: Strategic report + Risk scoring"
              )}
            </p>
          </div>
          <div className="rounded border border-border p-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {t(
                ...
                "Decryption of offshore shareholdings. KYC, KYS, AML-CFT, ESG audit. Deliverable: Complete forensic file"
              )}
            </p>
          </div>
        </div>
      ...
      <CaseStudy
        title={t("Cas client : Société de Capital-Risque (confidentiel — NDA strict)", "Case study: Venture Capital Firm (confidential — strict NDA)")}
        context={t(
          "Novembre 2024, due diligence sur une société de Capital Risque valorisée à 400M$ avant partenariat.",
          "November 2024, due diligence on a Venture Capital firm valued at $400M before partnership."
        )}
        intervention={[
          t("Deep Due Diligence 3 niveaux comprenant vérifications sur plateformes de sanctions internationales (ONU, OFAC, EU)", "3-level Deep Due Diligence including checks on international sanctions platforms (UN, OFAC, EU)"),
        ]}
        result={t(
          "Validation complète avec identification de points de vigilance. Partenariat verrouillé en toute sécurité.",
          "Complete validation with identification of vigilance points. Partnership secured safely."
        )}
      />
    </DetailPageLayout>
  );
