...
const AdvancedCapabilities = () => {
  ...
  const capabilities = [
    ...
    { icon: BookOpen, title: "Strategic Command Center", description: t("Le cockpit qui voit le présent et simule le futur. Pilotez vos 4 enjeux stratégiques — Risques, Opportunités, Concurrence, Narratif — et stress-testez vos arbitrages avant le marché.", "The cockpit that sees the present and simulates the future. Steer your 4 strategic issues — Risks, Opportunities, Competition, Narrative — and stress-test your arbitrations before the market."), route: "/capacites/strategic-command-center" },
