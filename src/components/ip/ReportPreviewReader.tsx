...
const COPY: Record<ReaderLang, Record<string, string>> = {
  fr: {
    kicker: "APERÇU GRATUIT · 8 PAGES SUR 21",
    ...
    lockedHint: "Pages 9 à 21 réservées : renseignez le formulaire pour accéder au rapport complet.",
    endTitle: "Vous avez consulté les 8 premières pages.",
    endBody:
      "Le rapport complet comprend 21 pages d’analyses, de signaux stratégiques et de précisions méthodologiques.",
  ...
  en: {
    kicker: "FREE PREVIEW · 8 OF 21 PAGES",
    ...
    of: "of",
    locked: "Locked page",
    lockedHint: "Pages 9 to 21 are restricted: complete the form to access the full report.",
    endTitle: "You have viewed the first 8 pages.",
    endBody:
      "The complete report contains 21 pages of analysis, strategic signals and methodological details.",
  ...
  ar: {
    kicker: "معاينة مجانية · 8 صفحات من أصل 21",
    ...
    of: "من",
    locked: "صفحة مقفلة",
    lockedHint: "الصفحات من 9 إلى 21 محجوزة: يرجى إكمال الاستمارة للوصول إلى التقرير الكامل.",
    endTitle: "لقد اطلعت على الصفحات الثماني الأولى.",
    endBody: "يتضمن التقرير الكامل 21 صفحة من التحليلات والإشارات الاستراتيجية والتوضيحات المنهجية.",
