...
const getSectors = (lang: "fr" | "en") => lang === "en" ? [
  { icon: "🚗", name: "Automotive", badge: "sc-fort" as SectorBadge, badgeLabel: "4th worldwide", mentions: 335, detail: "Consolidated automotive hub. Renault, Stellantis, BYD. Priority export to Europe.", comp: "Morocco 335 vs Vietnam 428", marocVal: 335, bestVal: 428, bestLabel: "Vietnam" },
  { icon: "✈️", name: "Aerospace", badge: "sc-leader" as SectorBadge, badgeLabel: "No. 1 worldwide", mentions: 118, detail: "Undisputed leader during the study period. Safran, Boeing, Airbus. Major African singularity.", comp: "Morocco No. 1 — no close competitor", marocVal: 118, bestVal: 118, bestLabel: "—" },
  { icon: "👕", name: "Textile", badge: "sc-moyen" as SectorBadge, badgeLabel: "Regional", mentions: 102, detail: "Regional competitor versus Tunisia and Bangladesh. Competitive workforce, EU proximity.", comp: "Morocco 102 vs Vietnam 238", marocVal: 102, bestVal: 238, bestLabel: "Vietnam" },
  { icon: "🌾", name: "Agri-food", badge: "sc-moyen" as SectorBadge, badgeLabel: "Potential", mentions: 98, detail: "Abundant natural resources. Developing AgriTech. African market to capture.", comp: "Morocco 98 vs South Africa 283", marocVal: 98, bestVal: 283, bestLabel: "South Africa" },
  { icon: "💊", name: "Pharma", badge: "sc-alert" as SectorBadge, badgeLabel: "Alert", mentions: 23, detail: "Critical under-exploited sector. Mexico invests US$643M. Strategic delay to urgently correct.", comp: "Morocco 23 vs Mexico 166", marocVal: 23, bestVal: 166, bestLabel: "Mexico" },
  { icon: "📞", name: "Outsourcing", badge: "sc-moyen" as SectorBadge, badgeLabel: "Nearshore", mentions: 31, detail: "European nearshore, bilingual, compatible time zones. Versus Tunisia and Poland.", comp: "Morocco 31 vs Mexico 83", marocVal: 31, bestVal: 83, bestLabel: "Mexico" },
  { icon: "💻", name: "Digital & Tech", badge: "sc-alert" as SectorBadge, badgeLabel: "Critical lag", mentions: 674, detail: "Lagging behind Vietnam (5519) and South Africa (5191). Major digital fragility.", comp: "Morocco 674 vs Vietnam 5519", marocVal: 674, bestVal: 5519, bestLabel: "Vietnam" },
  { icon: "⚓", name: "Shipbuilding", badge: "sc-moyen" as SectorBadge, badgeLabel: "Potential", mentions: 21, detail: "Strategic Atlantic frontage. Port infrastructure. Tanger Med as a major lever.", comp: "Limited data", marocVal: 21, bestVal: 21, bestLabel: "—" },
  { icon: "⚡", name: "Renewable Energy", badge: "sc-fort" as SectorBadge, badgeLabel: "3rd worldwide", mentions: 654, detail: "3rd worldwide position. NMGP gas pipeline US$25Bn. Continental energy hub.", comp: "Morocco 654 vs South Africa 3076", marocVal: 654, bestVal: 3076, bestLabel: "South Africa" },
] : [
  { icon: "🚗", name: "Automobile", badge: "sc-fort" as SectorBadge, badgeLabel: "4e mondial", mentions: 335, detail: "Hub automobile consolidé. Renault, Stellantis, BYD. Export prioritaire vers l'Europe.", comp: "Maroc 335 vs Vietnam 428", marocVal: 335, bestVal: 428, bestLabel: "Vietnam" },
  { icon: "✈️", name: "Aéronautique", badge: "sc-leader" as SectorBadge, badgeLabel: "N°1 mondial", mentions: 118, detail: "Leader incontesté sur la période d'étude. Safran, Boeing, Airbus. Singularité africaine majeure.", comp: "Maroc N°1 — aucun concurrent proche", marocVal: 118, bestVal: 118, bestLabel: "—" },
  { icon: "👕", name: "Textile", badge: "sc-moyen" as SectorBadge, badgeLabel: "Régional", mentions: 102, detail: "Concurrent régional face à la Tunisie et Bangladesh. Main d'œuvre compétitive, proximité UE.", comp: "Maroc 102 vs Vietnam 238", marocVal: 102, bestVal: 238, bestLabel: "Vietnam" },
  { icon: "🌾", name: "Agroalimentaire", badge: "sc-moyen" as SectorBadge, badgeLabel: "Potentiel", mentions: 98, detail: "Ressources naturelles abondantes. Agritech en développement. Marché africain à saisir.", comp: "Maroc 98 vs Afrique du Sud 283", marocVal: 98, bestVal: 283, bestLabel: "Afrique du Sud" },
  { icon: "💊", name: "Pharma", badge: "sc-alert" as SectorBadge, badgeLabel: "Alerte", mentions: 23, detail: "Secteur critique sous-exploité. Le Mexique investit 643M USD. Retard stratégique urgent.", comp: "Maroc 23 vs Mexique 166", marocVal: 23, bestVal: 166, bestLabel: "Mexique" },
  { icon: "📞", name: "Outsourcing", badge: "sc-moyen" as SectorBadge, badgeLabel: "Nearshore", mentions: 31, detail: "Nearshore Europe, bilingue, fuseaux horaires compatibles. Face à la Tunisie et Pologne.", comp: "Maroc 31 vs Mexique 83", marocVal: 31, bestVal: 83, bestLabel: "Mexique" },
  { icon: "💻", name: "Digital & Tech", badge: "sc-alert" as SectorBadge, badgeLabel: "Retard critique", mentions: 674, detail: "Retard vs Vietnam (5519) et Afrique du Sud (5191). Fragilité numérique majeure.", comp: "Maroc 674 vs Vietnam 5519", marocVal: 674, bestVal: 5519, bestLabel: "Vietnam" },
  { icon: "⚓", name: "Industrie Navale", badge: "sc-moyen" as SectorBadge, badgeLabel: "Potentiel", mentions: 21, detail: "Façade atlantique stratégique. Infrastructures portuaires. Tanger Med levier majeur.", comp: "Données limitées", marocVal: 21, bestVal: 21, bestLabel: "—" },
  { icon: "⚡", name: "Énergies Renouvelables", badge: "sc-fort" as SectorBadge, badgeLabel: "3e mondial", mentions: 654, detail: "3e position mondiale. Gazoduc NMGP 25 Mds USD. Hub énergétique continental.", comp: "Maroc 654 vs Afrique du Sud 3076", marocVal: 654, bestVal: 3076, bestLabel: "Afrique du Sud" },
];
