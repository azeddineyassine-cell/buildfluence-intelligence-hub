...
const SuccessStoriesSection = () => {
  ...
  const stories = [
    ...
    { topic: "communication", sector: "sante", tag: t("INGÉNIERIE DE COMMUNICATION", "COMMUNICATION ENGINEERING"), client: t("1er Livre Blanc e-Santé au Maroc", "Morocco's 1st e-Health White Paper"), desc: t("Analyse stratégique qui a influencé la politique publique de santé numérique au Maroc.", "Strategic analysis that influenced Morocco's digital health public policy."), anchor: "story-12" },
  ];
