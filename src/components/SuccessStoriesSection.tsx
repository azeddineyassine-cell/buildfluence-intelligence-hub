...
const SuccessStoriesSection = () => {
  ...
  const stories = [
    ...
    { topic: "audit", sector: "sante", tag: "Audit & Benchmark", client: "UM6SS", desc: t("Audit de gouvernance académique et benchmarking des standards d'excellence universitaire.", "Academic governance audit and benchmarking of university excellence standards."), anchor: "story-10" },
