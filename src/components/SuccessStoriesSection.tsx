...
const SuccessStoriesSection = () => {
  ...
  const stories = [
    ...
    { topic: "crise", sector: "agro", tag: t("Gestion de crise", "Crisis management"), client: "Centrale Danone", desc: t("Accompagnement dans la gestion d'une crise de confiance consommateurs avec stratégie de réponse multicanale.", "Support in managing a consumer confidence crisis with multichannel response strategy.") },
    ...
    { topic: "desinformation", sector: "agro", tag: t("Attaques & Désinformation", "Attacks & Disinformation"), client: "Centrale Danone", desc: t("Neutralisation d'une campagne de désinformation coordonnée sur les réseaux sociaux.", "Neutralization of a coordinated disinformation campaign on social media.") },
    { topic: "desinformation", sector: "energie", tag: t("Attaques & Désinformation", "Attacks & Disinformation"), client: "OCP Group", desc: t("Détection et neutralisation d'attaques informationnelles ciblant la crédibilité institutionnelle.", "Detection and neutralization of information attacks targeting institutional credibility.") },
    { topic: "desinformation", sector: "sport", tag: t("Attaques & Désinformation", "Attacks & Disinformation"), client: "Raja Club Athletic", desc: t("Protection de l'image du club face à des campagnes de manipulation médiatique.", "Protection of the club's image against media manipulation campaigns.") },
    ...
    { topic: "attractivite", sector: "institutions", tag: t("Attractivité & Rayonnement", "Attractiveness & Influence"), client: "ADD", desc: t("Stratégie globale d'attractivité des investissements directs étrangers et de rayonnement de la destination.", "Global strategy for foreign direct investment attractiveness and destination influence.") },
    { topic: "attractivite", sector: "institutions", tag: t("Attractivité & Rayonnement", "Attractiveness & Influence"), client: "CIDC", desc: t("Positionnement de la marque territoriale et développement de la compétitivité régionale.", "Territorial brand positioning and regional competitiveness development.") },
    { topic: "influence", sector: "sante", tag: t("Influence & Soft Power", "Influence & Soft Power"), client: "UM6SS", desc: t("Construction d'une stratégie de soft power académique et positionnement dans les réseaux d'influence internationaux.", "Building an academic soft power strategy and positioning within international influence networks.") },
    { topic: "influence", sector: "institutions", tag: t("Influence & Soft Power", "Influence & Soft Power"), client: "ADD", desc: t("Développement de l'influence institutionnelle et cartographie des décideurs clés.", "Institutional influence development and key decision-maker mapping.") },
    ...
    { topic: "audit", sector: "institutions", tag: "Audit & Benchmark", client: "ADD", desc: t("Audit stratégique complet et benchmark des meilleures pratiques internationales.", "Complete strategic audit and benchmark of international best practices.") },
    { topic: "audit", sector: "institutions", tag: "Audit & Benchmark", client: "CIDC", desc: t("Benchmark des dispositifs de compétitivité territoriale et recommandations d'optimisation.", "Benchmark of territorial competitiveness systems and optimization recommendations.") },
    { topic: "audit", sector: "sante", tag: "Audit & Benchmark", client: "UM6SS", desc: t("Audit de gouvernance académique et benchmarking des standards d'excellence universitaire.", "Academic governance audit and benchmarking of university excellence standards.") },
    { topic: "audit", sector: "sport", tag: "Audit & Benchmark", client: "Raja Club Athletic", desc: t("Audit des pratiques de gouvernance sportive et benchmark des clubs leaders africains.", "Sports governance practices audit and benchmark of leading African clubs.") },
    { topic: "communication", sector: "energie", tag: t("Ingénierie de communication", "Communication engineering"), client: "OCP Group", desc: t("Stratégie de communication Corporate, Veille et Renforcement d'image institutionnelle", "Corporate communication strategy, Monitoring and Institutional image strengthening") },
    ...
    { topic: "communication", sector: "institutions", tag: t("Ingénierie de communication", "Communication engineering"), client: "ADD", desc: t("Appui à la communication d'attractivité pour le renforcement institutionnel de l'agence", "Attractiveness communication support for the institutional strengthening of the agency") },
